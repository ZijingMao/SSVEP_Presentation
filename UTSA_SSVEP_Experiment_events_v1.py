...
window_handle = visual.Window([1920, 1080], fullscr=False, winType='pyglet', monitor='testMonitor', units='deg', screen=1, color=[-1, -1, -1], colorSpace='rgb')
...
square_face_number_frames = 2               # 3 frames ON and 3 frames OFF to make 15 Hz
...
# ----------------------------------------------------------------------------------------------------------------------
number_of_trials = 11
after_trial_pause = 1            # Pause in seconds
command_display_time = 3          # In seconds
...
countdown_time = core.CountdownTimer(20)      # Introduce artificial wait to sync events
