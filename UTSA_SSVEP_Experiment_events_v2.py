...
window_handle = visual.Window([1920, 1080], fullscr=False, winType='pyglet', monitor='testMonitor', units='deg',
                              screen=1, color=[-1, -1, -1], colorSpace='rgb')
...
square_left_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[-25, 0], sf=0,
...
square_right_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[25, 0], sf=0,
                                           color=[-1, -1, -1], colorSpace='rgb')
...
square_up_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[0, 13], sf=0, rgb=-1)
...
square_down_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[0, -13], sf=0, rgb=-1)
...
square_face_number_frames = 2               # 2 frames ON and 2 frames OFF to make 15 Hz
...
base_sequence = ['Up', 'Down', 'Left', 'Right', 'Face']
...
# ----------------------------------------------------------------------------------------------------------------------
number_of_trials = 1
after_trial_pause = 30            # Pause in seconds
command_display_time = 50          # In seconds
...
countdown_time = core.CountdownTimer(1)      # Introduce artificial wait to sync events
...
#            switch_flag_down = not switch_flag_down
    ...
    trial_text = 'Trial '+str(trial_done)+' has ended!. You will have '+str(after_trial_pause)+' seconds to rest'
    trial_indicator_text_stimulus.setAutoDraw(True)
    trial_indicator_text_stimulus.setText(trial_text)
