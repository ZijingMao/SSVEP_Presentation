...
# Command sequence
# base_sequence = ['Up', 'Down', 'Left', 'Right', 'Face', 'Extra']
...
number_of_trials = 4
after_trial_pause = 60
command_display_time = 6
...
square_extra_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[25, 13], sf=0, color=[-1, -1, -1], colorSpace='rgb')
square_face_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[-25, 13], sf=0, color=[-1, -1, -1], colorSpace='rgb')
square_down_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[0, -13], sf=0, color=[-1, -1, -1], colorSpace='rgb')
square_up_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[0, 13], sf=0, color=[-1, -1, -1], colorSpace='rgb')
square_right_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[25, 0], sf=0, color=[-1, -1, -1], colorSpace='rgb')
square_left_fixation = visual.GratingStim(win=window_handle, size=0.2, pos=[-25, 0], sf=0, color=[-1, -1, -1], colorSpace='rgb')
# ----------------------------------------------------------------------------------------------------------------------
